...
app = FastAPI(title="BTC Local Stack Manager", version="0.1.0")

logger = logging.getLogger("btc_stack.manager")
...
def health() -> dict:
    return {
        "status": "ok",
    "service": "btc-local-stack-manager",
        "timestamp": datetime.utcnow().isoformat(),
    }
...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .brand-btc { color:#f59e0b; font-size:11px; vertical-align:super; margin-left:2px; font-weight:700; }
...
<body>
  ...
  <link rel="shortcut icon" href="/favicon.ico?v=4" />
    ...
    <div class="brand-text">
      <span class="brand-title">HMM Local<sup class="brand-btc">BTC</sup></span>
      <span class="brand-subtitle">Home Miner Manager</span>
    </div>
  </div>
  <p>BTC Local Stack Manager • Coin fixed to BTC, algo fixed to sha256d.</p>
